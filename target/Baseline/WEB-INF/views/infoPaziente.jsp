...
<main>
    ...
    <div class="card card-cascade wider" id="informazioniPaziente" style="display: none">
        ...
        <div class="card-body ">
                ...
                <div class="md-form form-sm">
                    ...
                    <input type="text" id="dataNascita" class="form-control form-control-sm" name="dataNascita" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-map-marker prefix"></i>
                    <input type="text" id="luogoNascita" class="form-control form-control-sm" name="luogoNascita" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-map-marker prefix"></i>
                    <input type="text" id="provincia" class="form-control form-control-sm" name="provincia" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-group prefix"></i>
                    <input type="text" id="sesso" class="form-control form-control-sm" name="sesso" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-info-circle prefix"></i>
                    <input type="text" id="altezza" class="form-control form-control-sm" name="altezza" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-institution prefix"></i>
                    <input type="text" id="cittadinanza" class="form-control form-control-sm" name="cittadinanza" disabled>
                    <label for="nome">Nome</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-location-arrow prefix"></i>
                    <input type="text" id="residenza" class="form-control form-control-sm" name="residenza" disabled>
                    <label for="nome">Nome</label>
                </div>
    ...
    <script type="text/javascript">
        ...
        if(message==='Nessun Paziente'){
            ...
            $( "input#dataNascita" ).val(myJson.dataNascita);
            $( "input#luogoNascita" ).val(myJson.luogoNascita);
            $( "input#provincia" ).val(myJson.provincia);
            $( "input#sesso" ).val(myJson.sesso);
            $( "input#altezza" ).val(myJson.altezza);
            $( "input#cittadinanza" ).val(myJson.cittadinanza);
            $( "input#residenza" ).val(myJson.residenza);
